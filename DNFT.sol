...
contract keeperFlower is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    mapping (uint256=>string[5]) tokensIpfsUris;
    ...
    */
    function safeMint(address to, string [5] memory uris) public {
        uint256 tokenId = tokenIdCounter.current();
        tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, tokensIpfsUris[tokenId][0]);
    }
    ...
    function growFlower(uint256 _tokenId) public {
        ...
        // store the new URI
        string memory newUri = tokensIpfsUris[_tokenId][newVal];
        // Update the URI
    ...
    function flowerStage(uint256 _tokenId) public view returns (uint256) {
        ...
        string [5] memory IpfsUri=tokensIpfsUris[_tokenId]; //get uris

...
contract Pikachu is ERC721, ERC721URIStorage, KeeperCompatibleInterface {
   ...
   // Metadata information for each stage of the NFT on IPFS.
    ...
    constructor(uint _interval) ERC721("Pikachu", "PIKA") {
        interval = _interval;
    ...
    function evolvePokemon(uint256 _tokenId) public {
        if(pokemonStage(_tokenId) >= 4){return;}

...
2. En remix debes desplegar el contrato inteligente, para ellos necesitas tokens para la red de prueba rinkeby, que puedes solicitar en este [faucet](https://rinkebyfaucet.com/)
   - Para Goerli [faucet] (https://goerlifaucet.com/)
